...
export const VideoBackground = ({ overlayOpacity = 0.5 }: VideoBackgroundProps) => {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none">
      ...
      >
        <source src="/videos/piebackgroundreal.mp4" type="video/mp4" />
      </video>
      ...
      <div
        ...
        style={{
          ...
          background: `linear-gradient(180deg,
            hsl(231 56% 6% / ${overlayOpacity}) 0%,
            hsl(231 56% 8% / ${overlayOpacity * 0.9}) 50%,
            hsl(231 56% 6% / ${overlayOpacity}) 100%
          )`,
        }}
      />
      ...
      <div
        ...
        style={{
          top: '80px', // Start below the navigation header
          background: 'radial-gradient(ellipse at center, transparent 0%, hsl(231 56% 6% / 0.4) 100%)',
        }}
      />
