        ...
        <div className="card-surface-elevated p-6 sm:p-8">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-semibold mb-4">The Pie Stack Flow</h3>
              ...
              <div className="space-y-6 pt-4">
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-mono text-primary">{depositAmount[0]} MON</span>
                  </div>
                  <Slider
                    value={depositAmount}
              ...
              <div className="card-surface p-5">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="metric-value text-gradient-cyan">{estimatedYield} MON</p>
              ...
              <div className="card-surface p-5">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="metric-value text-amber-400">{potentialAwards} MON</p>
